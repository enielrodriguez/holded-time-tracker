...
fs.copyFileSync(
  path.join(FIREFOX_DIR, 'content.js'),
...
const zipPath = path.join(ROOT_DIR, 'dist', 'holded-time-tracker-firefox.zip');
...
try {
  ...
  console.log(`Firefox extension built successfully: ${zipPath}`);
} catch (error) {
