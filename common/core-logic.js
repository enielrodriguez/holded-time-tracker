...
// Get the browser API object (works in both Chrome and Firefox)
...
function updateWorkedTime(state) {
    try {
...
function setupIframeObserver(state) {
...
// Export functions for use in browser-specific content scripts
